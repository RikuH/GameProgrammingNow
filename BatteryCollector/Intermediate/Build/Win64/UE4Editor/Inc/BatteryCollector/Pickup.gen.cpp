...
// End Cross Module References
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_APickup_SetActive_Statics::Function_MetaDataParams[] = {
		{ "Category", "Pickup" },
		{ "ModuleRelativePath", "Pickup.h" },
		{ "ToolTip", "Allows other classes to safely change" },
	};
#endif
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_APickup_WasCollected_Statics::Function_MetaDataParams[] = {
		{ "ModuleRelativePath", "Pickup.h" },
		{ "ToolTip", "Functionto call when the pickup is collected" },
	};
#endif
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_APickup_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_APickup_IsActive, "IsActive" }, // 1658104033
		{ &Z_Construct_UFunction_APickup_SetActive, "SetActive" }, // 2565121905
		{ &Z_Construct_UFunction_APickup_WasCollected, "WasCollected" }, // 3281593565
	};
#if WITH_METADATA
	...
	IMPLEMENT_CLASS(APickup, 2237020756);
