...
// End Cross Module References
...
#endif
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_ABatteryPickup_Statics::NewProp_isDestroyable_MetaData[] = {
		{ "BlueprintProtected", "true" },
		{ "Category", "Power" },
		{ "ModuleRelativePath", "BatteryPickup.h" },
	};
#endif
	void Z_Construct_UClass_ABatteryPickup_Statics::NewProp_isDestroyable_SetBit(void* Obj)
	{
		((ABatteryPickup*)Obj)->isDestroyable = 1;
	}
	const UE4CodeGen_Private::FBoolPropertyParams Z_Construct_UClass_ABatteryPickup_Statics::NewProp_isDestroyable = { "isDestroyable", nullptr, (EPropertyFlags)0x0020080000000005, UE4CodeGen_Private::EPropertyGenFlags::Bool | UE4CodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(ABatteryPickup), &Z_Construct_UClass_ABatteryPickup_Statics::NewProp_isDestroyable_SetBit, METADATA_PARAMS(Z_Construct_UClass_ABatteryPickup_Statics::NewProp_isDestroyable_MetaData, ARRAY_COUNT(Z_Construct_UClass_ABatteryPickup_Statics::NewProp_isDestroyable_MetaData)) };
#if WITH_METADATA
	...
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_ABatteryPickup_Statics::PropPointers[] = {
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_ABatteryPickup_Statics::NewProp_isDestroyable,
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_ABatteryPickup_Statics::ClassParams = {
		...
		0,
		ARRAY_COUNT(Z_Construct_UClass_ABatteryPickup_Statics::PropPointers),
		0,
		0x009000A0u,
	...
	IMPLEMENT_CLASS(ABatteryPickup, 3506791474);
